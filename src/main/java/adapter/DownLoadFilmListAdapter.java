...
public class DownLoadFilmListAdapter extends RecyclerView.Adapter implements OnRetryableFileDownloadStatusListener {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater
                ...
                .inflate(R.layout.download_normal_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        //下载完成
        if(mDownloadFileInfo != null && mDownloadFileInfo.getDownloadedSizeLong() == mDownloadFileInfo.getFileSizeLong()){
            ...
            mConvertViews.put(url, new WeakReference<NormalViewHolder>((NormalViewHolder)holder));
        }
    }
