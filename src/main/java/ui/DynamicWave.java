...
public class DynamicWave extends View {
    ...
    public DynamicWave(Context context, AttributeSet attrs) {
        ...
        // 设置画笔颜色
        mWavePaint.setColor(getResources().getColor(R.color.DarkFontColor));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mTotalWidth; i++) {
            ...
            canvas.drawLine(i, mTotalHeight - mResetOneYPositions[i] -50, i,
                    mTotalHeight,
                    mWavePaint);
            mWavePaint.setColor(getResources().getColor(R.color.FontColor));
            // 绘制第二条水波纹
            canvas.drawLine(i, mTotalHeight - mResetTwoYPositions[i] -50, i,
                    mTotalHeight,
                    mWavePaint);
        }
